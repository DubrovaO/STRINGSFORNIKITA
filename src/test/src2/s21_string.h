...
#define BUFFSIZE 10000        //Размер буфера
...
char *s21_strncat(char *dest, const char *str, size_t n);
...
void helper_writeString(const char **format, char **str,
                        struct s_format *formatParams, char *string);
...
char *helper_ftoa(double f, struct s_format formatParams);
